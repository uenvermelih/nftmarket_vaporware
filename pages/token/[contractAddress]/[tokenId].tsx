...
import { MediaRenderer, ThirdwebNftMedia, Web3Button, useContract, useMinimumNextBid, useValidDirectListings, useBuyDirectListing, useValidEnglishAuctions } from "@thirdweb-dev/react";
...
export default function TokenPage({ nft, contractMetadata }: Props) {
    ...
    return(
        <Container maxW={"1200pc"} p={5} my={5}>
                    ...
                    <Box>
                        ...
                        <SimpleGrid columns={2} spacing={4}>
                            {Object.entries(nft?.metadata?.attributes || {}).map(
                                ([key, value]) => (
                                    <Flex key={key} direction={"column"} alignItems={"center"} justifyContent={"center"} borderWidth={2} p={"8px"} borderRadius={"4px"}>
